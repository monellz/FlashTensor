module {
  func.func @EA(%arg0: tensor<64x784x128xf32>, %arg1: tensor<384x128xf32>, %arg2: tensor<384xf32>, %arg3: tensor<128x128xf32>, %arg4: tensor<128xf32>) -> tensor<64x784x128xf32> {
    ...
    %10 = asuka.normalize %7, dim = 2, Lp = 1 : (tensor<64x4x784x32xf32>) -> tensor<64x4x784x32xf32>
    %11 = asuka.normalize %8, dim = 2, Lp = 1 : (tensor<64x4x784x32xf32>) -> tensor<64x4x784x32xf32>
    ...
    %14 = asuka.dot %7, %13, batch_dims = [0, 1] x [0, 1], reduce_dims = [3] x [2] : (tensor<64x4x784x32xf32>, tensor<64x4x32x32xf32>) -> tensor<64x4x784x32xf32>
