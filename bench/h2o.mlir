module {
  func.func @H2O(%arg0: tensor<4096x4096xf16>, %arg1: tensor<4096x4096xf16>, %arg2: tensor<4096x4096xf16>) -> (tensor<4096x4096xf16>, tensor<32x4096xf32>) {
    ...
    %13 = stablehlo.convert %11 : (tensor<32x4096x4096xf32>) -> tensor<32x4096x4096xf16>
    %14 = asuka.dot %13, %5, batch_dims = [0] x [0], reduce_dims = [2] x [1] : (tensor<32x4096x4096xf16>, tensor<32x4096x128xf16>) -> tensor<32x4096x128xf16>
    %15 = stablehlo.transpose %14, dims = [1, 0, 2] : (tensor<32x4096x128xf16>) -> tensor<4096x32x128xf16>
    %16 = stablehlo.reshape %15 : (tensor<4096x32x128xf16>) -> tensor<4096x4096xf16>
    return %16, %12 : tensor<4096x4096xf16>, tensor<32x4096xf32>
  }
}
